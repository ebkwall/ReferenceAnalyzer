...
namespace ReferenceAnalyzerTool
{
    ...
    public sealed class AnalyzerWindowCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("f134f489-1cf1-4e72-81b2-8dd8ef50a0f5");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AnalyzerWindowCommand"/> class.
        ...
        /// </summary>
        public static AnalyzerWindowCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in AnalyzerWindowCommand's constructor requires
            // the UI thread.
